...
export default function MobileCatPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-rose-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col min-h-[90vh]">
        {/* App-like Header */}
        <header className="flex items-center justify-center gap-2 py-3 border-b border-orange-100">
        ...
        <main className="flex-1 flex flex-col px-5 py-5">
          ...
          <div className="text-center mb-5">
            ...
            <h1 className="text-xl font-extrabold text-[var(--lemonade-dark)] mb-1">
              Coverage purr-fect for your cat
            </h1>
            <p className="text-[var(--lemonade-gray)] text-sm">
              Cat plans from $10/month, real coverage, simple signup
            </p>
          </div>

          {/* Quick Stats */}
          <div className="grid grid-cols-3 gap-2 mb-5 bg-orange-50 rounded-xl p-3">
        ...
        {/* Legal Footer */}
        <footer className="border-t border-orange-100 px-5 py-3 bg-orange-50">
          <div className="flex flex-wrap justify-center gap-x-3 gap-y-1 text-[10px] text-[var(--lemonade-gray)]">
            <Link href="/mobile-cat/contact" className="hover:text-orange-600 transition-colors">Contact Us</Link>
            <span>·</span>
            <Link href="/mobile-cat/terms" className="hover:text-orange-600 transition-colors">Terms</Link>
            <span>·</span>
            <Link href="/mobile-cat/privacy" className="hover:text-orange-600 transition-colors">Privacy</Link>
            <span>·</span>
            <Link href="/mobile-cat/ccpa" className="hover:text-orange-600 transition-colors">CCPA</Link>
          </div>
        </footer>
      </div>
    </div>
