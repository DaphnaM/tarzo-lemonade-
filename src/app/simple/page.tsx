          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="px-5 pb-5 text-center">
              ...
              <div className="flex items-center justify-center gap-1.5 mb-2">
                ...
                <span className="text-base font-bold text-[#4A4A4A]">Paw Policy chooses</span>
              </div>
              <h1 className="text-2xl font-extrabold text-[var(--lemonade-dark)] mb-1 flex items-center justify-center gap-2">
                <Image src="/images/lemonade-logo-grey.png" alt="Lemonade" width={140} height={32} className="inline-block" />
              </h1>
