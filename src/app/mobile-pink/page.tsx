...
export default function MobilePinkPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-200 via-pink-300 to-rose-400 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col min-h-[90vh]">
        {/* App-like Header */}
        <header className="flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-pink-500 to-rose-500">
        ...
        <main className="flex-1 flex flex-col px-5 py-5">
          ...
          <div className="relative w-full h-48 rounded-2xl overflow-hidden mb-5 -mt-2 shadow-lg">
            ...
            <div className="absolute top-3 left-3">
              <span className="inline-flex items-center gap-1 bg-white text-pink-600 px-3 py-1 rounded-full font-bold text-xs shadow-md">
                💖 #1 Loved
              </span>
            </div>
          </div>
          ...
          {/* Quick Stats */}
          <div className="grid grid-cols-3 gap-2 mb-5 bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl p-3 ring-1 ring-pink-100">
          ...
          <div className="space-y-2">
            <CTAButton size="large" className="w-full py-4 text-lg !bg-gradient-to-r !from-pink-500 !to-rose-500 hover:!from-pink-600 hover:!to-rose-600">
              Get My Price →
            </CTAButton>
        ...
        {/* Legal Footer */}
        <footer className="border-t border-pink-100 px-5 py-3 bg-gradient-to-r from-pink-50 to-rose-50">
          <div className="flex flex-wrap justify-center gap-x-3 gap-y-1 text-[10px] text-[var(--lemonade-gray)]">
            <Link href="/mobile-pink/contact" className="hover:text-pink-600 transition-colors">Contact Us</Link>
            <span>·</span>
            <Link href="/mobile-pink/terms" className="hover:text-pink-600 transition-colors">Terms</Link>
            <span>·</span>
            <Link href="/mobile-pink/privacy" className="hover:text-pink-600 transition-colors">Privacy</Link>
            <span>·</span>
            <Link href="/mobile-pink/ccpa" className="hover:text-pink-600 transition-colors">CCPA</Link>
          </div>
        </footer>
      </div>
    </div>
