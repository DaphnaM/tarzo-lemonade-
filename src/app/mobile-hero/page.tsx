...
export default function MobileHeroPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-100 via-green-100 to-lime-200 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col min-h-[90vh]">
        {/* App-like Header */}
        <header className="flex items-center justify-center gap-2 py-3 border-b border-emerald-100">
        ...
        <main className="flex-1 flex flex-col px-5 py-5">
          ...
          <div className="relative w-full h-44 rounded-2xl overflow-hidden mb-5">
            <Image
              ...
              alt="Hero dog outdoors"
              fill
              className="object-cover"
              priority
            />
            <div className="absolute top-3 left-3">
              <span className="inline-flex items-center gap-1 bg-emerald-600 text-white px-3 py-1 rounded-full font-bold text-xs shadow-md">
                ✅ Trusted
              </span>
            </div>
          </div>
          ...
          {/* Quick Stats */}
          <div className="grid grid-cols-3 gap-2 mb-5 bg-emerald-50 rounded-xl p-3">
        ...
        {/* Legal Footer */}
        <footer className="border-t border-emerald-100 px-5 py-3 bg-emerald-50">
          <div className="flex flex-wrap justify-center gap-x-3 gap-y-1 text-[10px] text-[var(--lemonade-gray)]">
            <Link href="/mobile-hero/contact" className="hover:text-emerald-600 transition-colors">Contact Us</Link>
            <span>·</span>
            <Link href="/mobile-hero/terms" className="hover:text-emerald-600 transition-colors">Terms</Link>
            <span>·</span>
            <Link href="/mobile-hero/privacy" className="hover:text-emerald-600 transition-colors">Privacy</Link>
            <span>·</span>
            <Link href="/mobile-hero/ccpa" className="hover:text-emerald-600 transition-colors">CCPA</Link>
          </div>
        </footer>
      </div>
    </div>
