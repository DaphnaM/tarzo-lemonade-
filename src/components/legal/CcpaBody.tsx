...
export default function CcpaBody({ theme }: { theme: LegalTheme }) {
  ...
  return (
    <>
      ...
      <h2 className={s.h2}>2. Use of Personal Information</h2>
      <p className={s.pTight}>
      ...
      <h2 className={s.h2}>3. Sharing Personal Information</h2>
      <p className={s.p}>
      ...
      <h2 className={s.h2}>4. Your Rights Under the CCPA</h2>
      <p className={s.p}>
      ...
      <p className={s.pBold}>Right to Know:</p>
      <p className={s.p}>
      ...
      <p className={s.pBold}>Right to Delete:</p>
      <p className={s.p}>
      ...
      <p className={s.pBold}>Right to Correct:</p>
      <p className={s.p}>
        You have the right to request that we correct inaccurate personal information that we maintain about you.
      </p>
      <p className={s.pBold}>Right to Opt-Out of Sale or Sharing:</p>
      <p className={s.p}>
      ...
      <p className={s.pBold}>Right to Non-Discrimination:</p>
      <p className={s.p}>
      ...
      <p className={s.pBold}>Right to Limit Use of Sensitive Personal Information:</p>
      <p className={s.p}>
      ...
      <h2 className={s.h2}>5. How to Exercise Your Rights</h2>
      <p className={s.pTight}>
      ...
      <ul className={s.ul}>
        <li>Emailing us at: <a className={s.link} href="mailto:contact@pawpolicy.pro">contact@pawpolicy.pro</a></li>
      ...
      <h2 className={s.h2}>6. Response Timing and Format</h2>
      <p className={s.p}>
      ...
      <h2 className={s.h2}>7. Contact Information</h2>
      <p className={s.pTight}>
